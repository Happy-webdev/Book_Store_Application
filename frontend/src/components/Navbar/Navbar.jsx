...
const [MobileNav,setMobileNav]=useState("hidden");
  return (
    ...
    <div className={`${MobileNav} bg-zinc-800 h-screen absolute left-0 top-0 z-40 w-full flex flex-col items-center justify-center`}>
     ...
     {isLoggedIn === false && (   <>  <Link to="/LogIn" className={`${MobileNav} px-8 py-2 text-3xl font-semibold mb-8 border border-blue-500 rounded text-white hover:bg-white hover:text-zinc-800 transition-all duration-300`}>LogIn</Link >
